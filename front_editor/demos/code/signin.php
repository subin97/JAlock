      ...
      <div class="col-sm-9 col-md-7 col-lg-5 mx-auto">
        <div class="card card-signin my-5">
          <div class="card-body">
            ...
            <form class="form-signin" method="post" action="/jalock/front_editor/demos/code/signin_back.php">
            ...
            <form class="form-signin" >
              <a href="/jalock/front_editor/demos/code/signup.php" class="btn btn-lg btn-primary btn-block text-uppercase">회원가입</a>
            </form>
          </div>
        </div>
      </div>
